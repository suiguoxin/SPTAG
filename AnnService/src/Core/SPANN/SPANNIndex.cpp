...
#pragma region K-NN search
        ...
        ErrorCode Index<T>::SearchIndex(QueryResult &p_query, bool p_searchDeleted) const
        {
            ...
            if (m_extraSearcher != nullptr) {
                ...
                m_extraSearcher->SearchIndex(workSpace.get(), *p_queryResults, m_index, nullptr, m_options.m_enableDeltaEncoding, m_options.m_enableDataCompression, m_options.m_enableDictTraining);
            ...
            SearchStats* p_stats, std::set<int>* truth, std::map<int, std::set<int>>* found)
        {
            ...
            for (SizeType p = 0; p < partitions; p++) {
                ...
                m_extraSearcher->SearchIndex(auto_ws.get(), newResults, m_index, p_stats, m_options.m_enableDeltaEncoding, m_options.m_enableDataCompression, m_options.m_enableDictTraining, truth, found);
            }
